...
LookLeftTool::LookLeftTool(View& view)
	: LookAtTool(view)
{ }

LookLeftTool::~LookLeftTool() = default;

glm::mat4 LookLeftTool::_calculateViewMatrix(Float distance, const glm::vec3& target) const {
