#ifndef LUCCA_LOOK_TOP_TOOL_HPP
#define LUCCA_LOOK_TOP_TOOL_HPP
 ...
 */
class LUCCA_API LookTopTool final : public LookAtTool {
public:
	LookTopTool(View& view);
	virtual ~LookTopTool();
